...
try {
    ...
    Write-Host "⚠️ Skipping rights tests due to error: $($_.Exception.Message)" -ForegroundColor Yellow
}
...
try {
    ...
    Write-Host "⚠️ Skipping account sharing tests due to error: $($_.Exception.Message)" -ForegroundColor Yellow
}
...
try {
    ...
    Write-Host "⚠️ Skipping automated rights tests due to error: $($_.Exception.Message)" -ForegroundColor Yellow
}
